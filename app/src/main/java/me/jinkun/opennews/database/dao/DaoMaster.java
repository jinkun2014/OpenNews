...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        NewsTopicDao.createTable(db, ifNotExists);
        NewsReadDao.createTable(db, ifNotExists);
        NewsDetailDao.createTable(db, ifNotExists);
        NewsImageDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        NewsChannelDao.dropTable(db, ifExists);
        NewsTopicDao.dropTable(db, ifExists);
        NewsReadDao.dropTable(db, ifExists);
        NewsDetailDao.dropTable(db, ifExists);
        NewsImageDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(NewsTopicDao.class);
        registerDaoClass(NewsReadDao.class);
        registerDaoClass(NewsDetailDao.class);
        registerDaoClass(NewsImageDao.class);
    }
