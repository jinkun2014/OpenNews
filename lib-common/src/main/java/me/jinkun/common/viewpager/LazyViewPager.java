...
public class LazyViewPager extends ViewGroup {
    ...
    /**
     * CHANNEL_ID of the active pointer. This is used to retain consistency during
...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     * Set a drawable that will be used to fill the margin between pages.
     *
     * @param resId Resource CHANNEL_ID of a drawable to display between pages
     */
    ...
    void populate() {
        ...
        //pageLimit原来的viewpager源码中维护的是1
        final int pageLimit = mOffscreenPageLimit;

        //startPos为viewpager添加界面起始位置的索引值
        //mCurItem当前viewpager所处界面的索引值
